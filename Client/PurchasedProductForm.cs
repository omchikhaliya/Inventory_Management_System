...
namespace Client
{
    public partial class PurchasedProductForm : Form
    {
        public PurchasedProductForm()
        {
            InitializeComponent();
        }

        private void PurchasedProductForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet ds = proxy.GetPurchasedProducts();
